...
int decryption(int c, int d, int n, int input)
{
    long double potegaCD = pow(c, d);
    int t=input; //=potegaCD%n;
    return t;
}
...
int main()
{
    ...
    if (input > n)
    {
        cout << "Zla konfiguracja liczb input>n, Try againg" << endl;
        return 0;
    }
